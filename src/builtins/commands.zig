...
pub const slash_specs = [_]SlashSpec{
    ...
    .{ .kind = .notifications, .command = "/sound", .help_entry = "/sound [on|off|max]", .completion_description = "toggle sounds and attention bells", .presentation_category = .appearance, .has_args = true, .accepts_payload = true },
